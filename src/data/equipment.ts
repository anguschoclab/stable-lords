...
export const WEAPONS: EquipmentItem[] = [
  ...
  },
  {
    ...
    reqWT: 3,
    reqDF: 7,
    description: 'Versatile light blade. CW for Parry-Strike. W for most styles.',
    preferredStyles: [
      FightingStyle.ParryStrike,
      FightingStyle.StrikingAttack,
      FightingStyle.LungingAttack,
  ...
  },
  {
    ...
    reqWT: 11,
    reqDF: 3,
    description: 'Light shield. CW for Total-Parry.',
    preferredStyles: [FightingStyle.TotalParry, FightingStyle.WallOfSteel],
    coverage: 'MEDIUM',
  },
  {
    id: 'war_hammer',
    ...
    reqWT: 5,
    reqDF: 7,
    description: 'Light crushing weapon. Armor-piercing.',
    preferredStyles: [
  ...
  // Medium weapons (weight 3-4)
  {
    ...
    reqWT: 11,
    reqDF: 11,
    description: 'Curved slashing blade. CW for Slasher. W for most styles.',
    preferredStyles: [
      FightingStyle.SlashingAttack,
      FightingStyle.StrikingAttack,
      FightingStyle.WallOfSteel,
  ...
  },
  {
    ...
    reqWT: 3,
    reqDF: 7,
    description: 'Crushing weapon. CW for Basher.',
  ...
  },
  {
    ...
    reqWT: 13,
    reqDF: 11,
    description: 'Versatile blade. CW for Parry-Lunge. W for most styles.',
    preferredStyles: [
      FightingStyle.ParryLunge,
      FightingStyle.StrikingAttack,
      FightingStyle.LungingAttack,
  ...
  },
  {
    ...
    reqWT: 7,
    reqDF: 9,
    description: 'Heavy chopping weapon. Better for Strikers and Slashers than Bashers.',
    preferredStyles: [
      FightingStyle.StrikingAttack,
      FightingStyle.SlashingAttack,
      FightingStyle.WallOfSteel,
  ...
  },
  {
    ...
    reqWT: 9,
    reqDF: 7,
    description: 'Standard arena sword. CW for Striker. W for most styles.',
    preferredStyles: [
      FightingStyle.StrikingAttack,
      FightingStyle.SlashingAttack,
      FightingStyle.WallOfSteel,
  ...
  },
  {
    ...
    reqWT: 11,
    reqDF: 3,
    description: 'Standard shield. CW for Total-Parry. +2 DEF.',
    preferredStyles: [FightingStyle.TotalParry, FightingStyle.WallOfSteel],
    restrictedStyles: [FightingStyle.LungingAttack],
    coverage: 'MEDIUM',
  },
  {
    id: 'morning_star',
  ...
  },
  {
    ...
    reqWT: 5,
    reqDF: 7,
    description: 'Thrusting polearm. CW for Lunger. W for parry styles.',
    preferredStyles: [
      FightingStyle.LungingAttack,
      FightingStyle.StrikingAttack,
      FightingStyle.ParryLunge,
  ...
  },
  {
    ...
    reqDF: 9,
    twoHanded: true,
    description: 'Maximum reach polearm. No shield.',
    preferredStyles: [
      FightingStyle.StrikingAttack,
      FightingStyle.LungingAttack,
      FightingStyle.ParryLunge,
    ...
    restrictedStyles: [FightingStyle.TotalParry, FightingStyle.ParryRiposte],
  },
  {
    id: 'halberd',
    code: 'HL',
    ...
    reqDF: 11,
    twoHanded: true,
    description: 'Polearm with devastating reach. No shield.',
    preferredStyles: [FightingStyle.BashingAttack, FightingStyle.StrikingAttack],
    restrictedStyles: [
      FightingStyle.AimedBlow,
      FightingStyle.TotalParry,
  ...
  },
  {
    ...
    reqDF: 7,
    twoHanded: true,
    description: 'Giant war hammer. No shield.',
    preferredStyles: [FightingStyle.BashingAttack, FightingStyle.StrikingAttack],
    restrictedStyles: [
      FightingStyle.AimedBlow,
      FightingStyle.LungingAttack,
...
export const ARMORS: EquipmentItem[] = [
  {
    ...
    slot: 'armor',
    weight: 0,
    description: 'No armor. Maximum speed.',
  },
  {
    id: 'leather',
    code: 'ALE',
    ...
    slot: 'armor',
    weight: 2,
    description: 'Light protection. Minimal encumbrance.',
  },
  {
    id: 'padded_leather',
    code: 'APL',
    ...
    slot: 'armor',
    weight: 4,
    description: 'Reinforced leather. Good balance.',
  },
  {
    id: 'ring_mail',
    code: 'ARM',
    ...
    slot: 'armor',
    weight: 6,
    description: 'Linked rings over padding.',
  },
  {
    id: 'scale_mail',
    code: 'ASM',
