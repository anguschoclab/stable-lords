...
export default function WarriorDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Overview Tab */}
      {/* Biometrics Tab - Focuses on stats and physical assessment */}
      {activeTab === "biometrics" && (
        <div className="grid gap-6 lg:grid-cols-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
          {/* Attributes Column */}
          <div className="lg:col-span-4 space-y-6">
            <Card className="bg-glass-card border-neon overflow-hidden border">
      ...
      {/* Mission Control Tab - Functional preparation and tactics */}
      {activeTab === "mission" && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
           {/* Primary Strategy Hub */}
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-glass-card border-neon rounded-2xl overflow-hidden border">
                <div className="bg-secondary/10 px-6 py-4 border-b border-border/40 flex items-center gap-3">
                  ...
                  <span className="font-display font-black uppercase tracking-widest text-xs">Logistics: Armory Loadout</span>
                </div>
                <div className="p-6">
                  <EquipmentLoadoutUI
              ...
              <div className="bg-glass-card border-neon rounded-2xl overflow-hidden border">
                <div className="bg-secondary/10 px-6 py-4 border-b border-border/40 flex items-center gap-3">
                  ...
                  <span className="font-display font-black uppercase tracking-widest text-xs">Intelligence: Scouting Assist</span>
                </div>
      ...
      {/* Chronicle Tab - Career History & Legend */}
      {activeTab === "chronicle" && (
          ...
          <div className="lg:col-span-8">
            <div className="bg-glass-card border-border/40 border rounded-3xl overflow-hidden min-h-[600px]">
              <div className="bg-secondary/10 px-8 py-6 border-b border-border/40">
                 ...
                 <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest mt-1">Classified Bout Records</p>
              </div>
              <div className="p-8">
