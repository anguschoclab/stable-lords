        ...
        <Link to="/recruit">
          <Surface variant="glass" className="px-5 py-4 border-border/30 hover:border-primary/50 transition-all flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-muted-foreground uppercase tracking-widest">Scout new recruits</div>
            </div>
          </Surface>
        </Link>
        <Link to="/trainers">
          <Surface variant="glass" className="px-5 py-4 border-border/30 hover:border-primary/50 transition-all flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-muted-foreground uppercase tracking-widest">Trainers + mentors</div>
            </div>
          </Surface>
        </Link>
        <Link to="/ledger">
          <Surface variant="glass" className="px-5 py-4 border-border/30 hover:border-primary/50 transition-all flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-muted-foreground uppercase tracking-widest">Full year-end detail</div>
            </div>
          </Surface>
        </Link>
      </div>
