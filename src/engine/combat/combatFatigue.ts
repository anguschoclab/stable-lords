...
// Fatigue thresholds
const FATIGUE_MODERATE_THRESHOLD = 0.60; // Increased to trigger moderate fatigue earlier
const FATIGUE_HEAVY_THRESHOLD = 0.35; // Increased to trigger heavy fatigue earlier

// Fatigue penalties
const FATIGUE_MODERATE_PENALTY = -2;
const FATIGUE_HEAVY_PENALTY = -6; // Increased penalty to make fatigue more punishing
