...
export function logAgentAction(
  ...
  if (type === "FINANCE" && (description.includes("hoard") || description.includes("saving"))) currentIntent = "WEALTH_ACCUMULATION";
  if (type === "STRATEGY" && (description.includes("aggressive") || description.includes("dominance"))) currentIntent = "AGGRESSIVE_EXPANSION";
  if (type === "ROSTER" && (description.includes("scout") || description.includes("diversify"))) currentIntent = "ROSTER_DIVERSITY";
