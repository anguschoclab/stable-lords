...
describe('Trainer System', () => {
  ...
  describe('convertRetiredToTrainer', () => {
    ...
    it('should assign tier based on career stats', () => {
      const novice = makeWarrior(FightingStyle.StrikingAttack, {
        career: { wins: 3, losses: 2, kills: 0 },
      });
      const seasoned = makeWarrior(FightingStyle.StrikingAttack, {
        career: { wins: 8, losses: 4, kills: 1 },
      });
      const master = makeWarrior(FightingStyle.StrikingAttack, {
        career: { wins: 20, losses: 10, kills: 5 },
      });
    ...
    it('should promote to Master with 3+ kills even with low fight count', () => {
      const killer = makeWarrior(FightingStyle.LungingAttack, {
        career: { wins: 5, losses: 0, kills: 3 },
      });
