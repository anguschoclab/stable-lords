...
function addTournamentParticipants(
  ...
  const participants = participantIds.map(id => {
    const warrior = [...state.roster, ...(state.rivals?.flatMap(r => r.roster) || [])].find(w => w.id === (id as WarriorId));
    return warrior || makeWarrior(
      id as WarriorId,
      `Warrior ${id}`,
...
describe("PromoterPass", () => {
  ...
  describe("Personality-based purse modifiers", () => {
    ...
    it("should apply +20% purse when both warriors have fame > 75 for Flashy promoters", () => {
      ...
      const highFameOffer = offers.find(o => 
        o.warriorIds.includes("high_fame_1" as WarriorId) || o.warriorIds.includes("high_fame_2" as WarriorId)
      );
  ...
  describe("Personality-based hype modifiers", () => {
    ...
    it("should increase hype by 10% for Honorable promoters when fame difference < 50", () => {
      ...
      const honorableOffer = offers.find(o => 
    ...
    it("should increase hype by 25 for Sadistic promoters with high-kill warriors", () => {
      ...
      const sadisticOffer = offers.find(o => 
        o.promoterId === "sadistic" &&
        (o.warriorIds.includes("killer_warrior" as WarriorId) || o.warriorIds.includes("victim_warrior" as WarriorId))
      );
    ...
    it("should increase hype by 15 for Flashy promoters when warriors have fame > 100", () => {
      ...
      const flashyOffer = offers.find(o => 
        o.promoterId === "flashy" && o.warriorIds.includes("famous_warrior" as WarriorId)
      );
  ...
  describe("Flashy promoter showy-style matching", () => {
    ...
    it("should apply +10% hype when both warriors have showy styles", () => {
      ...
      const showyOffer = offers.find(o => 
        o.warriorIds.includes("showy_a" as WarriorId) && o.warriorIds.includes("showy_b" as WarriorId)
      );
