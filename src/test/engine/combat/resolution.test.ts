...
describe("getMatchupBonus", () => {
  it("returns positive bonus for favorable matchups", () => {
    ...
    expect(getMatchupBonus(FightingStyle.StrikingAttack, FightingStyle.SlashingAttack)).toBeDefined();
  });
  ...
  it("returns 0 for neutral matchups", () => {
    ...
    expect(getMatchupBonus(FightingStyle.StrikingAttack, FightingStyle.StrikingAttack)).toBeDefined();
  });
});
