    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[9px] text-muted-foreground font-black uppercase tracking-[0.2em] opacity-60">
                  Faculty_Enlistment // Active_Staff: {activeTrainers.length}
                </span>
                          ...
                          <TooltipTrigger asChild>
                            <div className="flex flex-col gap-1 mx-auto w-full max-w-40">
                              <StatBattery
                                ...
                                colorClass={
                                  isExpiring ? 'bg-destructive animate-pulse' : 'bg-primary'
                                }
                              />
                              {isExpiring && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Surface
          variant="glass"
          padding="md"
          className="bg-neutral-900/40 border-border/10 flex items-center gap-6 group hover:border-destructive/30 transition-all"
        >
          ...
          <div>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-40">
              System_Fiscal_Impact
            </p>
            <p className="text-xl font-mono font-black text-destructive drop-shadow-[0_0_10px_rgba(255,0,0,0.2)]">
              -{totalWeeklyExpense.toLocaleString()}G / Cycle
            </p>
            <p className="text-[8px] font-black text-muted-foreground/60 uppercase tracking-widest mt-1">
              Aggregated_Personnel_Maintenance
            </p>
          </div>
        </Surface>
        ...
        <Surface
          variant="glass"
          padding="md"
          className="bg-neutral-900/40 border-border/10 flex items-center gap-6 group hover:border-primary/30 transition-all"
        >
          ...
          <div>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-40">
              Strategic_Operational_Status
            </p>
            <p className="text-xl font-display font-black uppercase text-foreground group-hover:text-primary transition-colors">
              Martial_Optimization
            </p>
            <p className="text-[8px] font-black text-muted-foreground/60 uppercase tracking-widest mt-1">
              Institutional_Efficiency_Synced
            </p>
          </div>
        </Surface>
      </div>
