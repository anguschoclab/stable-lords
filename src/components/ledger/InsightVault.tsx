        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 relative z-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-1">
              ...
              <span className="font-mono text-[10px] font-black text-primary/60">
                {statTokens.length} / --
              </span>
            </div>
            ...
            <div className="space-y-3">
              {statTokens.length === 0 ? (
                <Surface
                  variant="glass"
                  className="py-12 text-center border-dashed border-white/5 opacity-40"
                >
                  <Lock className="h-8 w-8 mx-auto mb-3 text-muted-foreground" />
                  <p className="text-[9px] font-black uppercase tracking-widest leading-none">
                    Vulnerabilities Obscured
                  </p>
                </Surface>
              ) : (
                statTokens.map((t) => (
                  <Surface
                    ...
                    variant="paper"
                    padding="sm"
                    className="bg-primary/5 border border-primary/20 hover:border-primary/50 transition-all group cursor-default"
                  >
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center gap-2">
                        <Shield className="h-3 w-3 text-primary opacity-60" />
                        <span className="text-[11px] font-display font-black uppercase text-primary tracking-tight group-hover:drop-shadow-[0_0_5px_rgba(var(--primary-rgb),0.4)] transition-all">
                          {t.warriorName}
                        </span>
                      </div>
                      <span className="text-[8px] font-mono font-black text-muted-foreground/60 tracking-widest">
                        SEQ {t.discoveredWeek.toString().padStart(2, '0')}
                      </span>
                    </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-1">
              ...
              <span className="font-mono text-[10px] font-black text-arena-gold/60">
                {weaponTokens.length} / --
              </span>
            </div>
              ...
              {weaponTokens.length === 0 ? (
                ...
                weaponTokens.map((t) => (
                  <Surface
                    ...
                    variant="paper"
                    padding="sm"
                    className="bg-arena-gold/5 border border-arena-gold/20 hover:border-arena-gold/50 transition-all group cursor-default"
                  >
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center gap-2">
                        <Target className="h-3 w-3 text-arena-gold opacity-60" />
                        <span className="text-[11px] font-display font-black uppercase text-arena-gold tracking-tight group-hover:drop-shadow-[0_0_5px_rgba(255,215,0,0.4)] transition-all">
                          {t.warriorName}
                        </span>
                      </div>
                      <span className="text-[8px] font-mono font-black text-muted-foreground/60 tracking-widest">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-1">
              ...
              <span className="font-mono text-[10px] font-black text-arena-pop/60">
                {rhythmTokens.length} / --
              </span>
            </div>
              ...
              {rhythmTokens.length === 0 ? (
                ...
                rhythmTokens.map((t) => (
                  <Surface
                    ...
                    variant="paper"
                    padding="sm"
                    className="bg-arena-pop/5 border border-arena-pop/20 hover:border-arena-pop/50 transition-all group cursor-default"
                  >
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center gap-2">
                        <Zap className="h-3 w-3 text-arena-pop opacity-60" />
                        <span className="text-[11px] font-display font-black uppercase text-arena-pop tracking-tight group-hover:drop-shadow-[0_0_5px_rgba(var(--arena-pop-rgb),0.4)] transition-all">
                          {t.warriorName}
                        </span>
                      </div>
                      <span className="text-[8px] font-mono font-black text-muted-foreground/60 tracking-widest">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/5">
          ...
          <div className="p-8 flex items-center gap-6 group hover:bg-white/2 transition-all">
            ...
            <div>
              ...
              <span className="text-xl font-mono font-black text-arena-gold">
                {weaponTokens.length}S
              </span>
              <span className="text-[8px] font-black text-muted-foreground/60 uppercase tracking-widest block mt-0.5">
                Verified Intel
              </span>
          ...
          <div className="p-8 flex items-center gap-6 group hover:bg-white/2 transition-all">
            ...
            <div>
              ...
              <span className="text-xl font-mono font-black text-arena-pop">
                {rhythmTokens.length}K
              </span>
              <span className="text-[8px] font-black text-muted-foreground/60 uppercase tracking-widest block mt-0.5">
                Verified Intel
              </span>
