  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[8rem] items-start gap-1.5 rounded-none border border-border/50 bg-background px-2.5 py-1.5 text-xs shadow-xl backdrop-blur-md',
          className
        )}
      >
...
// Helper to resolve config from a key or dataKey.
function getResolvedConfig(config: ChartConfig, key: string) {
