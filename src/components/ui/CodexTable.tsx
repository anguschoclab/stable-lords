...
const tableVariants = cva('w-full border-collapse overflow-hidden', {
  variants: {
    variant: {
...
const headerVariants = cva('font-display font-black uppercase tracking-wider text-left border-b', {
  variants: {
    variant: {
...
const cellVariants = cva('border-b border-border/20', {
  variants: {
    density: {
      compact: 'px-2 py-1.5',
      default: 'px-4 py-2.5',
