      ...
      <div className="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-neutral-900/40 backdrop-blur-md">
        ...
        <Link to="/ops/personnel">
          <Button
            variant="outline"
            size="sm"
            className="bg-neutral-900 border-white/10 text-[10px] font-black uppercase tracking-[0.2em] gap-2 h-10 px-6 hover:bg-primary hover:text-white hover:border-primary transition-all"
          >
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                              <div className="space-y-1.5">
                                ...
                                <div className="flex items-center gap-3">
                                  <StatBadge
                                    styleName={w.style as import('@/types/game').FightingStyle}
                                    career={w.career}
                                  />
                                  <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-none bg-black border border-white/5 opacity-80 group-hover:border-primary/30 group-hover:opacity-100 transition-all">
                                    ...
                                    <span
                                      className={cn(
                                        ...
                                        w.fame > 1000 ? 'text-arena-gold' : 'text-muted-foreground'
                                      )}
                                    >
                                      {w.fame}G
                                    </span>
