    ...
    return rounds.filter(([round, bouts]) => {
      ...
      switch (filter) {
        ...
        case "current-round":
          ...
          const firstPendingRound = Array.from(roundsMap.entries())
            .find(([_, bs]) => bs.some(b => b.winner === undefined));
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Card className="bg-gradient-to-br from-emerald-500/5 to-transparent">
          <CardContent className="p-3">
            ...
            <div className="text-xl font-black font-mono mt-1 text-emerald-600">{stats.completed}</div>
          </CardContent>
        </Card>
