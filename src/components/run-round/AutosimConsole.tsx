              ...
              <div className="bg-background/40 p-3 rounded-none border border-accent/20 flex items-center justify-between animate-in fade-in slide-in-from-bottom-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-mono text-muted-foreground uppercase">
                    Wk {progress.lastSummary.week}: {progress.lastSummary.bouts} Bouts
                  </span>
                </div>
          ...
          <div className="space-y-4 animate-in zoom-in-95 duration-300">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="bg-secondary/20 p-3 rounded-none border border-border/10">
                <span className="text-[8px] font-black uppercase text-muted-foreground block mb-1">
                  Total Cycles
                </span>
              ...
              <div className="bg-secondary/20 p-3 rounded-none border border-border/10">
                ...
                <span className="font-mono text-sm font-bold text-destructive">
                  {result.weekSummaries.reduce((s, w) => s + w.deaths, 0)} Deaths
                </span>
              </div>
            </div>
