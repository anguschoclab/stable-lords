...
export function WarriorHeroHeader({ warrior, record, streakLabel, streakVal, id, isPlayerOwned, insightTokens }: WarriorHeroHeaderProps) {
  ...
  return (
    <div className="relative rounded-none border border-[rgba(60,42,22,0.8)] bg-[#120D09] p-4 sm:p-8 overflow-hidden shadow-xl"
      style={{ borderTopColor: "rgba(80,55,30,0.45)", borderLeftColor: "rgba(70,48,26,0.4)", backgroundImage: "linear-gradient(135deg,rgba(255,245,220,0.018) 0%,transparent 60%,rgba(200,120,20,0.02) 100%)" }}>
