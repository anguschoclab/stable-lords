       ...
       <div className="lg:col-span-4 space-y-6">
          ...
          <Surface variant="glass" padding="none">
             <div className="p-4 bg-secondary/5 border-b border-white/5 flex items-center gap-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-foreground">Hall of Records</span>
             </div>
          ...
          {warrior.awards && warrior.awards.length > 0 && (
            <Surface variant="glass" padding="none">
               <div className="p-4 bg-primary/5 border-b border-white/5 flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-arena-gold">Awards & Accolades</span>
               </div>
               <div className="p-5 space-y-4">
                  {warrior.awards.map((award, i) => (
                     <div key={i} className="space-y-2">
                        <div className="flex justify-between items-center">
                           <span className="text-[9px] font-black uppercase text-arena-gold/60 tracking-[0.2em]">Year {award.year}</span>
                           <span className="text-[9px] font-black uppercase tracking-widest bg-secondary/30 px-2 py-0.5 border border-white/5">{award.type.replace(/_/g, " ")}</span>
                        </div>
       ...
       <div className="lg:col-span-8">
         <Surface variant="glass" padding="none" className="min-h-[600px]">
           <div className="bg-secondary/10 px-8 py-6 border-b border-white/5 flex items-center justify-between">
              <h2 className="font-display font-black uppercase text-2xl tracking-tighter text-foreground">Engagement Archive</h2>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground/40">Chronicle // V1.0</div>
           </div>
           <div className="p-8">
