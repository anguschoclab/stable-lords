      ...
      <div className="lg:col-span-4 space-y-6">
        <Surface variant="glass" padding="none" className="border-neon overflow-hidden">
          <div className="p-5 border-b border-white/5 bg-secondary/10 flex items-center gap-2">
            ...
            <span className="font-display font-black text-[10px] uppercase tracking-widest text-foreground">Physical Polygon</span>
          </div>
          <div className="p-6">
            <WarriorRadarChart warrior={warrior} />
            <div className="mt-8 space-y-4">
               <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase text-muted-foreground/60 tracking-widest">Recent Form</span>
               ...
               <div className="pt-2 text-[11px] flex items-start gap-2">
                 ...
                 <p className="text-muted-foreground/80 italic leading-relaxed">{overallGrowthNarrative(warrior)}</p>
               </div>
            </div>
          </div>
        </Surface>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Surface variant="glass" padding="none">
            <div className="p-4 bg-secondary/5 border-b border-white/5 flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-foreground">Physical Vitals</span>
            </div>
          ...
          <Surface variant="glass" padding="none">
            <div className="p-4 bg-secondary/5 border-b border-white/5 flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-foreground">Coach's Notes</span>
            </div>
