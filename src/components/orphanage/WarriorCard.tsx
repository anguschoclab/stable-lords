    ...
    >
      ...
      <div className="p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-muted-foreground/80 font-medium mb-1">
            {warrior.origin}
          </p>
        ...
        <div className="shrink-0 text-right space-y-1">
          ...
          <div className="flex items-center justify-end gap-1">
            <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/40">POT</span>
            <span className={`text-[11px] font-mono font-black ${
              potentialGrade(potentialRating(warrior.potential)) === 'S' ? 'text-accent' : 
              potentialGrade(potentialRating(warrior.potential)) === 'A' ? 'text-arena-gold' : 'text-foreground/80'
            }`}>
